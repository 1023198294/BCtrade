...
if [ "$CC_SRC_LANGUAGE" = "go" ] ; then
	CC_SRC_PATH="../chaincode/bctrade/java"
#elif [ "$CC_SRC_LANGUAGE" = "javascript" ]; then
#	CC_SRC_PATH="../chaincode/bctrade/javascript/"
elif [ "$CC_SRC_LANGUAGE" = "java" ]; then
	CC_SRC_PATH="../chaincode/bctrade/java"
#elif [ "$CC_SRC_LANGUAGE" = "typescript" ]; then
#	CC_SRC_PATH="../chaincode/bctrade/typescript/"
else
...
./network.sh deployCC -ccn bctrade -ccv 1 -cci initLedger -ccl ${CC_SRC_LANGUAGE} -ccp ${CC_SRC_PATH}
popd
